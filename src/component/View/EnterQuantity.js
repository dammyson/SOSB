...
export default class EnterQuantity extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <Animatable.View style={{ height: Dimensions.get('window').height / 3, alignItems: 'center', justifyContent: 'center', borderRadius: 2 }} animation="fadeInUpBig" >
                        ...
                        <View style={{ height: Dimensions.get('window').height / 3, width: Dimensions.get('window').width - 50, }} >
                            <View style={styles.body_top}>
                                ...
                                <Text style={{ fontSize: 14, margin: 7, flex: 1, fontFamily: 'NunitoSans-Bold', color: '#fff', textAlign: 'center', marginRight: 10 }}>Add  Quantity</Text>
                            ...
                            <View style={styles.body}>
                                ...
                                <View style={{ paddingTop: 1, flexDirection: 'row', alignItems: 'center', }}>
                                    ...
                                    <View style={{ paddingTop: 1, marginRight: 25, }}>

                                        <TouchableOpacity style={{ marginBottom: 5 }} onPress={() => this.updateCount('+')}>
                                            <Icon
                                                name="upcircle"
                                                size={20}
                                                type='antdesign'
                                        ...
                                        <TouchableOpacity style={{ marginTop: 5 }} onPress={() => this.updateCount('-')}>
                                            <Icon
                                                name="downcircle"
                                                size={20}
                                                type='antdesign'
